---
title: A Workflow For Bayesian Modelling and Reporting in R
output:
...
`r icon::fa("envelope")` mikhail @ mpopov.com
...
`r icon::fa("code")` [github.com/bearloga/fts-bayesian-r-workflow-2019](https://github.com/bearloga/fts-bayesian-r-workflow-2019)
...
.footnote[These will soon be moved to the **broom.mixed** `r emojifont::emoji("package")` which is not yet on CRAN]
...
or @bearloga in `r icon::fa("slack")`
